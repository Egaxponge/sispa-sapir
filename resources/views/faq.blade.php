						...
						<ul id="main-menu-buttons" class="menu">
							<li id="menu-item-400"
								class="menu-item menu-item-type-post_type menu-item-object-page menu-item-400"><a
									href="/form">Cek Tingkat Penyakit Hewan Anda</a></li>
						</ul>
					</div>
				</nav>
			</div>
                ...
                <div class="accordion" id="faqAccordion">
                    ...
                    <div class="card">
                        <div class="card-header" id="headingFour">
                            <h2 class="mb-0">
                                <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                    ...
                                    Bagaimana cara mengakses solusi yang ditawarkan Diagnosa penyakit hewan?
                                </button>
                            </h2>
                        </div>
                        <div id="collapseFour" class="collapse" aria-labelledby="headingFour"
                            data-parent="#faqAccordion">
                            <div class="card-body">
                                Setelah mengisi formulir, pengakses atau peternak akan menerima rekomendasi solusi sesuai dengan
                                tingkat Penyakit yang terdeteksi. Kami juga menyediakan tautan ke sumber informasi dan
                                bantuan profesional yang dapat membantu peternak menyelesaikan masalah penyakit pada hewan ternak mereka.
                            </div>
                        </div>
                    </div>
                </div>
